...
function constructsql(where){
	var sql="select invoice.*,sum(IFNULL(serviceinvoice.paidAmount,0)) as service,sum(IFNULL(serviceinvoice.paidAmount,0))+nontaxable+other as total from contract \
