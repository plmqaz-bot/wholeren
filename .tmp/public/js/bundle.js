...
},{"./View":2,"backbone":20,"jquery":39}],2:[function(require,module,exports){
"use strict";
var $ = require('jquery');
//var Backbone = require('backbone');
...
},{"../assets/js/backbone.modal.js":18,"./models":4,"./template/contract.hbs":5,"./template/contract_single.hbs":6,"./template/modals/material.hbs":7,"./template/modals/reply.hbs":8,"./template/notification.hbs":9,"./template/settings/general.hbs":10,"./template/settings/keyword.hbs":11,"./template/settings/keyword_single.hbs":12,"./template/settings/message.hbs":13,"./template/settings/replymaterial.hbs":14,"./template/settings/replymaterial_add.hbs":15,"./template/settings/replymaterial_single.hbs":16,"./template/settings/sidebar.hbs":17,"hbsfy/runtime":19,"jquery":39,"lodash":40}],3:[function(require,module,exports){
(function (global){
﻿(function(){
	var $ = require('jquery');
    var Backbone = require('backbone');
...
},{"./Router":1,"./View":2,"./models":4,"backbone":20,"handlebars":37,"jquery":39,"lodash":40}],4:[function(require,module,exports){
var Backbone = require('backbone');
$ = require('jquery');
Backbone.$ = $;
Models = {};
...
},{"backbone":20,"jquery":39}],5:[function(require,module,exports){
...
},{"hbsfy/runtime":19}],6:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  return buffer + "\n<td><a href=\"#"
    + escapeExpression(((helper = helpers.idReplyMaterial || (depth0 && depth0.idReplyMaterial)),(typeof helper === functionType ? helper.call(depth0, {"name":"idReplyMaterial","hash":{},"data":data}) : helper)))
    + "\"><img src=\"/public/assets/img/red-delete-button.jpg\" class=\"remove\" width=\"50\" /></a></td>\n</tr>  ";
},"useData":true});

},{"hbsfy/runtime":19}],7:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":19}],13:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  var helper, functionType="function", escapeExpression=this.escapeExpression;
...
},{"hbsfy/runtime":19}],14:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[5,">= 2.0.0"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":19}],15:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  return " selected ";
...
},{"hbsfy/runtime":19}],16:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  var helper, functionType="function", escapeExpression=this.escapeExpression;
...
},{"hbsfy/runtime":19}],17:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[5,">= 2.0.0"],"main":function(depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":19}],18:[function(require,module,exports){
var Backbone = require('backbone');
var _ = require('lodash')
...
},{"backbone":20,"lodash":40}],19:[function(require,module,exports){
module.exports = require("handlebars/runtime")["default"];

},{"handlebars/runtime":38}],20:[function(require,module,exports){
//     Backbone.js 1.1.2
...
},{"../dist/cjs/handlebars":23,"../dist/cjs/handlebars/compiler/printer":31,"../dist/cjs/handlebars/compiler/visitor":32,"fs":22}],38:[function(require,module,exports){
// Create a simple path alias to allow browserify to resolve
// the runtime on a supported path.
module.exports = require('./dist/cjs/handlebars.runtime');

},{"./dist/cjs/handlebars.runtime":24}],39:[function(require,module,exports){
/*!
